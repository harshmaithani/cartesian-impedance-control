...
int main(int argc, char **argv)
{
   ...
   */
   ...
   commanded_pose.position.x=0.078;
   commanded_pose.position.y=current_pose_rpy.position.y + y*2.5;
 commanded_pose.position.z=current_pose_rpy.position.z + z*2.5;  //Active Following
//   commanded_pose.position.z=0.868;
