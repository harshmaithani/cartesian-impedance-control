...
namespace kuka_lwr_controllers
{
	...
	bool ComputedTorqueController::init(hardware_interface::KUKAJointInterface *robot, ros::NodeHandle &n)
	{
...
PLUGINLIB_EXPORT_CLASS(kuka_lwr_controllers::ComputedTorqueController, controller_interface::ControllerBase)
