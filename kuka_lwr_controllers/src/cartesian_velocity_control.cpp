...
namespace kuka_lwr_controllers 
{
    ...
    void CartesianVelocityControl::command(const kuka_lwr_controllers::PoseRPY::ConstPtr &msg)
    {
...
PLUGINLIB_EXPORT_CLASS(kuka_lwr_controllers::CartesianVelocityControl, controller_interface::ControllerBase)
