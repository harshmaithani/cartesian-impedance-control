...
#ifndef LWR_CONTROLLERS_HARSH_CARTESIAN_IMPEDANCE_CONTROLLER_H
#define LWR_CONTROLLERS_HARSH_CARTESIAN_IMPEDANCE_CONTROLLER_H
...
#define TRACE_CARTESIAN_IMPEDANCE_CONTROLLER_ACTIVATED 0

namespace kuka_lwr_controllers
{
	class HarshCartesianImpedanceController: 
	public controller_interface::KinematicChainControllerBase<hardware_interface::KUKACartesianInterface>
	{
		public:
			HarshCartesianImpedanceController();
			~HarshCartesianImpedanceController();
		...
		private:
			...
			ros::Publisher pub_cart_imp_kdl_joint_acceleration_radss_;
			//ros::Publisher pub_robot_joint_acceleration_degss_;
			...
			ros::Publisher pub_cart_imp_kdl_mass_inertia_matrix_;    // Publish Inertia Matrix M(q) computed using KDL
			ros::Publisher pub_cart_imp_kdl_coriolis_torques_;       // Publish Coriolis Torques C(q,q_dot) computed using KDL
			ros::Publisher pub_cart_imp_kdl_gravity_torques_;        // Publish Gravity Torques g(q) computed using KDL
			...
			KDL::JntArray				coriolis_torques_ , gravity_torques_;  // Coriolis and Gravity vectors
			KDL::JntSpaceInertiaMatrix  mass_inertia_matrix_ ;
			...
			std_msgs::Float64MultiArray  robot_joint_acceleration_radss_;
			//std_msgs::Float64MultiArray  robot_joint_acceleration_degss_;
			...
			std_msgs::Float64MultiArray  robot_mass_inertia_matrix_; 
			std_msgs::Float64MultiArray  robot_coriolis_torques_;
			std_msgs::Float64MultiArray  robot_gravity_torques_;
			
            // Laurent
            std::vector<double> joint_acceleration_, joint_velocity_prev_;
