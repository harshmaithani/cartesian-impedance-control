...
# Ip address of Hand Computer -> 192.168.100.113
...
ip_address_associate_hand_computer="192.168.100.113"
...
do_start()
{
	...
	echo "Add host route (hand computer) for switch !"
	sleep 5
	sudo route add -host $ip_address_associate_hand_computer dev $ethX_associate_switch
}
